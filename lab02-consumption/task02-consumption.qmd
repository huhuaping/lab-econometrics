...
（1）实验目标：一元回归；OLS估计；预测；消费案例。

（2）实验任务：题目及答题纸.docx文件下载`lab02-consumption.docx`（请登陆西北农林科技大学在线教育综合平台）[.](lab02-consumption.docx)

（3）实验数据集：.xlsx数据文件下载`lab02-dataset.zip`（请登陆西北农林科技大学在线教育综合平台）[.](dataset/lab02-dataset-`r params$teach_year`/lab02-dataset-`r params$teach_year`.zip)
