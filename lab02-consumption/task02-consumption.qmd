...
（2）实验任务：题目及答题纸.docx文件下载（请登陆西北农林科技大学在线教育综合平台）[lab02-consumption.docx](lab02-consumption.docx)

（3）实验数据集：.xlsx数据文件下载（请登陆西北农林科技大学在线教育综合平台）[lab02-dataset.zip](dataset/lab02-dataset-`r params$teach_year`/lab02-dataset-`r params$teach_year`.zip)
