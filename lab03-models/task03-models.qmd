...
（2）实验任务：题目及答题纸.docx文件下载`lab03-models.docx`（请登陆西北农林科技大学在线教育综合平台）[.](lab03-models.docx)

（3）实验数据集：.xlsx数据文件下载`lab03-dataset.zip`（请登陆西北农林科技大学在线教育综合平台）[.](dataset/lab03-dataset-`r params$teach_year`/lab03-dataset-`r params$teach_year`.zip)
